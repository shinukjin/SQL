 --오라클에 데이터에 계정을 만들 때는 SYSTEM 또는 SYS계정으로 한다.
 SHOW USER;
...
--
--ORA-01045 : 오라클 에러코드
--오라클 에러코드 인터넷에서 검색해서 에러를 디버깅한다.
--
--맨처음 유저를 생성하면
--달랑 유저만 생성되기 때문에 
--연결권한
--테이블 생성권한을 부여해야 한다. 해당하는 유저에


--연결권한주기
--GRANT CREATE SESSION TO : 유저에게 연결권한을 주는 구문
